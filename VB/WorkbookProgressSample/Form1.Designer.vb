...
'ORIGINAL LINE: this.btnRunCancel.Click += new System.EventHandler(this.RunCancel_Click);
			' 
			' Form1
			' 
			...
			Me.Icon = (CType(resources_Conflict.GetObject("$this.Icon"), System.Drawing.Icon))
...
'ORIGINAL LINE: this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Form1_FormClosing);
		...
		Private WithEvents btnRunCancel As System.Windows.Forms.Button
	End Class
End Namespace
